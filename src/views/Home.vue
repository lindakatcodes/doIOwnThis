<template>
  <div class="home">
    <div v-if="!signedIn" class="intro">
      ...
      <p>
        Ever run into this problem - you're out at the store, browsing your
        favorite items. But then you stop to wonder - "Do I already own this
        one?" Or maybe it's "Do I have enough purples?"
      </p>

      <p>
        Well wonder no longer! Now, you can keep track of the items you own for
        your favorite collections, and easily verify if you've already got that
        shade or style!
      </p>
